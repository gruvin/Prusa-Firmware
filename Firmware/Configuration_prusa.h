...
/** MODIFIED for Gruvinator i3p (prototype) **/
...
// Printer name
#define CUSTOM_MENDEL_NAME "Gruvinator i3p"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.5, 80.5, 393.0, 97.0}  
...
#define DEFAULT_MAX_FEEDRATE          {500, 500, 40, 80}    // (mm/sec)
